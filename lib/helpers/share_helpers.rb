...
module ShareHelpers
  ...
  def mail_share_url(article)
    ...
    body = ERB::Util.url_encode(full_url(article.path, utm_source: 'email', utm_medium: 'email', utm_campaign: 'share-button'))
  ...
  def sms_share_url(article)
    ...
    url = full_url(article.path, utm_source: 'sms', utm_medium: 'sms', utm_campaign: 'share-button')
    text = "#{title} #{url}"
  ...
  def facebook_share_url(article)
    url = ERB::Util.url_encode(full_url(article.path, utm_source: 'facebook', utm_medium: 'social', utm_campaign: 'share-button'))
  ...
  def reddit_share_url(article)
    ...
    url = ERB::Util.url_encode(full_url(article.path, utm_source: 'reddit', utm_medium: 'social', utm_campaign: 'share-button'))
  ...
  def bluesky_share_url(article)
    title = sanitize(article.title)
    url = full_url(article.path, utm_source: 'bluesky', utm_medium: 'social', utm_campaign: 'share-button')
    text = "#{title}\n\n#{url}"
  ...
  def threads_share_url(article)
    title = sanitize(article.title)
    url = full_url(article.path, utm_source: 'threads', utm_medium: 'social', utm_campaign: 'share-button')
  ...
  def mastodon_share_url(article)
    title = sanitize(article.title)
    url = full_url(article.path, utm_source: 'mastodon', utm_medium: 'social', utm_campaign: 'share-button')
    text = "#{title}\n\n#{url}"
    encoded_text = ERB::Util.url_encode(text)

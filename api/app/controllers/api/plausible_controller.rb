module Api
  ...
  class PlausibleController < ActionController::Base
    def pageviews
      ...
      return render(plain: "") if published_at.blank? || site_id.blank?
      ...
      return render(plain: "") if result.nil?

      @pageviews = result.dig(:results, 0, :metrics, 0).to_i

      tz = ENV.fetch("TIME_ZONE", "America/Denver")

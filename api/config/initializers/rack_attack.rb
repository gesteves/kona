...
RACK_ATTACK_KNOWN_PREFIXES = %w[/up /api /widgets /webhooks /whoop /sidekiq /signin /signout /auth /connected-apps /spam /location /republish /course-maps /social /assets].freeze

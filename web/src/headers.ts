 ...
 * as the `/*` block of that file: `test/fixtures/security_headers.json` holds the list, and a test
 * on each side compares its file with it. The CSP is not here, on purpose: it is long, it is Report-Only,
